...
import com.wzq.sample.databinding.FragmentDemoBinding;
 ...
 */
public class DemoFragment extends BaseFragment<FragmentDemoBinding, DemoViewModel> {
     ...
     * 封装布局中的点击事件儿;
     */
    public class Presenter extends DemoFragment {

        //网络访问点击事件
        public void netWorkClick() {
            NavHostFragment
                    .findNavController(DemoFragment.this)
                    .navigate(R.id.action_demoFragment_to_netWorkFragment);
        }
        ...
        public void rvMultiClick() {
            NavHostFragment
                    .findNavController(DemoFragment.this)
                    .navigate(R.id.action_demoFragment_to_multiRecycleViewFragment);
        }
        ...
        public void viewPagerBindingClick() {
            ...
            NavHostFragment
                    .findNavController(DemoFragment.this)
                    .navigate(R.id.action_demoFragment_to_viewPagerGroupFragment);
        }
        ...
        public void formModifyClick() {
            ...
            NavHostFragment
                    .findNavController(DemoFragment.this)
                    .navigate(R.id.action_demoFragment_to_formFragment, mBundle);
        }
        ...
        public void roomSampleClick() {
            NavHostFragment
                    .findNavController(DemoFragment.this)
                    .navigate(R.id.action_demoFragment_to_roomSampleFragment);
        }
        ...
        public void testNetUrl() {
            NavHostFragment
                    .findNavController(DemoFragment.this)
                    .navigate(R.id.action_demoFragment_to_testNetFragment);
        }
    ...
    private void downFile(String url) {
         ...
         */
        DownLoadManager.getInstance().load(url, new ProgressCallBack<ResponseBody>(DemoFragment.this, destFileDir, destFileName) {
            @Override
            public void onStart() {
                super.onStart();
                KLog.e("下载--onStart");
