...
public class StatusBarUtil {
    ...
    /**
     * 增加View的paddingTop,增加的值为状态栏 hight  (智能判断，并设置 hight )
     *
...
//        }
    ...
    private final static boolean IS_FLYME_OS =Pattern.compile("Flyme OS [4|5]", Pattern.CASE_INSENSITIVE).matcher(Build.DISPLAY).find();
    /**
     * 判断 is 否Flyme4以上
     */
     ...
     *
     * @param activity         目标activity
     * @param fitSystemWindows  is 否预留toolbar的 hight
     */
